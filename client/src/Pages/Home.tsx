...
import { Heart, UserPlus, LogIn, Droplets, Users, Calendar, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 p-8">
                ...
                <p className="text-muted-foreground">Lives lost annually due to blood shortage</p>
              </CardContent>
            </Card>
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 p-8">
                ...
                <p className="text-muted-foreground">Critical cases requiring immediate transfusion</p>
              </CardContent>
            </Card>
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              <CardContent className="pt-6 p-8">
                ...
                <p className="text-muted-foreground">Patients need blood during surgery</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold mb-6">How Your Blood Donation Helps</h2>
            <p className="text-muted-foreground text-lg">
              A single donation can save up to three lives. Your contribution makes a real difference.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {['Emergency Care', 'Cancer Treatment', 'Childbirth Support'].map((title, index) => (
              <motion.div
                key={title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-muted-foreground">
                  {index === 0 && "Critical support for trauma and emergency surgery patients."}
                  {index === 1 && "Essential for patients undergoing chemotherapy and treatments."}
                  {index === 2 && "Vital support for complicated pregnancies and childbirth."}
                </p>
              </motion.div>
            ))}
          </div>
      ...
      >
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Join our community of heroes and help ensure that no one suffers due to blood shortage.
          </p>
        </div>
      </motion.section>
      ...
      <footer className="py-8 border-t">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Our Blood Bank. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
